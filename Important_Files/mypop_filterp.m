% MYPOP_FILTERP is a version of MYPOP_FILTERP
% EDITED by Michelle Maiden
%
% PURPOSE  :	Filters ERP data
%
% FORMAT   :
%
% ERP = mypop_filterp(ERP,  chanArray, parameters)
%
%
% INPUTS   :
%
...
%
%
% See also basicfilterGUI2 myfilterp.m
%
...
function [ERP, erpcom] = mypop_filterp(ERP, samplerate,  chanArray, varargin)
erpcom = '';
...
if nargin==1
    ...
    % Somersault
    %
    [ERP, erpcom] = mypop_filterp( ERP, chanArray, 'Filter',ftype, 'Design',  fdesign, 'Cutoff', cutoff, 'Order', filterorder, 'RemoveDC', rdc,...
...
ERP     = myfilterp(ERP, samplerate, options{:});
% ERP.saved  = 'no';
% 
