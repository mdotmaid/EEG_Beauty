...
function ERP = myfilterp(ERP, samplerate, chanArray, locutoff, hicutoff, filterorder, typef, remove_dc)
...
fnyquist  = 0.5*samplerate;       % half sample rate
pnts      = length(ERP);%size(ERP.bindata,2);
...
[b, a, labelf, v] = filter_tf(typef, filterorder, hicutoff, locutoff, samplerate);
